# IMDb Pro Installer - Professional UI with Custom Icons
Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.Drawing

# Download and load custom diamond icon
$iconUrl = "https://github.com/cdn-my/Movie-Player-Pro/blob/main/diamond.png?raw=true"
$iconPath = "$env:TEMP\diamond_icon.png"
...
foreach ($feature in $features) {
    ...
    $featurePanel.BorderColor = [System.Drawing.Color]::FromArgb(60, 60, 60)
    ...
    $iconPanel.BorderStyle = [System.Windows.Forms.BorderStyle]::None
    $featurePanel.Controls.Add($iconPanel)
    
    # Add diamond shape using label
...
$installButton.Add_MouseEnter({
    ...
    $this.Size = New-Object System.Drawing.Size(410, 75)
    $this.Location = New-Object System.Drawing.Point(220, 28)
})
...
$installButton.Add_MouseLeave({
    if ($this.Text -ne "INSTALLATION COMPLETE") {
        ...
        $this.Size = New-Object System.Drawing.Size(400, 70)
        $this.Location = New-Object System.Drawing.Point(225, 30)
    }
})
